...
export const metadata = {
  ...
  openGraph: { title: 'AI Sales Copy Generator', description: 'Generate persuasive sales copy that converts visitors into customers. AI-powered copywriting for landing pages and emails.' },
  twitter: { title: 'AI Sales Copy Generator', description: 'Generate persuasive sales copy that converts visitors into customers. AI-powered copywriting for landing pages and emails.' }
};
