...
export const metadata = {
  ...
  openGraph: { title: 'Viral Shorts Generator - AI YouTube Shorts Scripts', description: 'Generate viral YouTube Shorts scripts for 30, 45, and 60 second durations. Optimized for retention and engagement.' },
  twitter: { title: 'Viral Shorts Generator - AI YouTube Shorts Scripts', description: 'Generate viral YouTube Shorts scripts for 30, 45, and 60 second durations. Optimized for retention and engagement.' }
};
