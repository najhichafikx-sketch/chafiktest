...
export const metadata = {
  ...
  openGraph: { title: 'Viral Hook Generator - Scroll-Stopping Video Hooks', description: 'Generate attention-grabbing video hooks for YouTube. First 5 seconds, 15 seconds, and full scroll-stopping hooks that boost retention.' },
  twitter: { title: 'Viral Hook Generator - Scroll-Stopping Video Hooks', description: 'Generate attention-grabbing video hooks for YouTube. First 5 seconds, 15 seconds, and full scroll-stopping hooks that boost retention.' }
};
