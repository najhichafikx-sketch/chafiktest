...
export const metadata = {
  ...
  openGraph: { title: 'YouTube Description Generator - AI SEO Descriptions', description: 'Generate SEO-optimized YouTube descriptions with hashtags, keywords, and timestamps to rank higher in search.' },
  twitter: { title: 'YouTube Description Generator - AI SEO Descriptions', description: 'Generate SEO-optimized YouTube descriptions with hashtags, keywords, and timestamps to rank higher in search.' }
};
