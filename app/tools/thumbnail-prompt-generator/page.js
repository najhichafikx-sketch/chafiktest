...
export const metadata = {
  ...
  openGraph: { title: 'Thumbnail Prompt Generator - AI YouTube Thumbnails', description: 'Generate AI thumbnail prompts with subject, colors, composition, and emotion for click-worthy YouTube thumbnails.' },
  twitter: { title: 'Thumbnail Prompt Generator - AI YouTube Thumbnails', description: 'Generate AI thumbnail prompts with subject, colors, composition, and emotion for click-worthy YouTube thumbnails.' }
};
