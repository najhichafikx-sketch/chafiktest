...
export const metadata = {
  ...
  openGraph: { title: 'Amazon Listing Generator', description: 'Create optimized Amazon product listings with high-converting titles, bullet points, and descriptions that rank.' },
  twitter: { title: 'Amazon Listing Generator', description: 'Create optimized Amazon product listings with high-converting titles, bullet points, and descriptions that rank.' }
};
