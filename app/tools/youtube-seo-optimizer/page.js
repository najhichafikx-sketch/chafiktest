...
export const metadata = {
  ...
  openGraph: { title: 'YouTube SEO Optimizer - AI Video Ranking Analysis', description: 'Analyze your YouTube title and description. Get an SEO score and actionable suggestions to rank higher in search results.' },
  twitter: { title: 'YouTube SEO Optimizer - AI Video Ranking Analysis', description: 'Analyze your YouTube title and description. Get an SEO score and actionable suggestions to rank higher in search results.' }
};
