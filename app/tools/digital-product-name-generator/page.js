...
export const metadata = {
  ...
  openGraph: { title: 'Digital Product Name Generator', description: 'Generate catchy, memorable names for your digital products, courses, templates, and online offerings.' },
  twitter: { title: 'Digital Product Name Generator', description: 'Generate catchy, memorable names for your digital products, courses, templates, and online offerings.' }
};
