...
export const metadata = {
  ...
  openGraph: { title: 'AI Product Idea Finder', description: 'Discover profitable product ideas for your e-commerce store with AI-powered market research and trend analysis.' },
  twitter: { title: 'AI Product Idea Finder', description: 'Discover profitable product ideas for your e-commerce store with AI-powered market research and trend analysis.' }
};
