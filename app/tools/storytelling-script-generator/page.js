...
export const metadata = {
  ...
  openGraph: { title: 'Storytelling Script Generator - AI Narrative Videos', description: 'Generate storytelling-driven YouTube scripts for history, mystery, documentary, and educational channels.' },
  twitter: { title: 'Storytelling Script Generator - AI Narrative Videos', description: 'Generate storytelling-driven YouTube scripts for history, mystery, documentary, and educational channels.' }
};
