...
export const metadata = {
  ...
  openGraph: { title: 'AI YouTube Creator Suite', description: '12 AI-powered tools for YouTube thumbnails, transcripts, SEO optimization, viral ideas, channel analysis, and growth planning.' },
  twitter: { title: 'AI YouTube Creator Suite', description: '12 AI-powered tools for YouTube thumbnails, transcripts, SEO optimization, viral ideas, channel analysis, and growth planning.' }
};
