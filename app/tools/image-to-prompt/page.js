...
export const metadata = {
  ...
  openGraph: { title: 'Image to Prompt Generator', description: 'Upload any image and instantly generate ultra-detailed, professional prompts for Midjourney, DALL-E, and Stable Diffusion.' },
  twitter: { title: 'Image to Prompt Generator', description: 'Upload any image and instantly generate ultra-detailed, professional prompts for Midjourney, DALL-E, and Stable Diffusion.' }
};
