...
export const metadata = {
  ...
  openGraph: { title: 'AI TikTok Creator Suite', description: 'Generate viral TikTok scripts, find trending sounds, and optimize hashtags with AI-powered tools for TikTok growth.' },
  twitter: { title: 'AI TikTok Creator Suite', description: 'Generate viral TikTok scripts, find trending sounds, and optimize hashtags with AI-powered tools for TikTok growth.' }
};
