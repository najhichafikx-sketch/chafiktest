...
export const metadata = {
  ...
  openGraph: { title: 'Product Image Enhancer', description: 'Generate AI-powered prompts to enhance and optimize your product images for better conversions and visual appeal.' },
  twitter: { title: 'Product Image Enhancer', description: 'Generate AI-powered prompts to enhance and optimize your product images for better conversions and visual appeal.' }
};
