...
export const metadata = {
  ...
  openGraph: { title: 'Faceless Video Generator - AI Script & Visual Prompts', description: 'Generate complete faceless video packages: scripts, voiceover prompts, visual prompts, and B-roll suggestions for YouTube.' },
  twitter: { title: 'Faceless Video Generator - AI Script & Visual Prompts', description: 'Generate complete faceless video packages: scripts, voiceover prompts, visual prompts, and B-roll suggestions for YouTube.' }
};
