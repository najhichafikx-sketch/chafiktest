...
export const metadata = {
  ...
  openGraph: { title: 'Shopify SEO Generator', description: 'Generate SEO-optimized product titles, descriptions, and meta tags for your Shopify store to drive organic traffic.' },
  twitter: { title: 'Shopify SEO Generator', description: 'Generate SEO-optimized product titles, descriptions, and meta tags for your Shopify store to drive organic traffic.' }
};
