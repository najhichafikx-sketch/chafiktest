...
export const TOOL_ARTICLES = {
  ...
  'viral-ideas': { slug: 'youtube-viral-ideas', title: 'YouTube Viral Video Ideas – AI-Powered Content Strategy' },
  'youtube-title': { slug: 'youtube-title-optimization', title: 'YouTube Title Optimization – Rank Higher with AI' },
  'viral-hook': { slug: 'viral-hook-generation', title: 'Viral Hook Generator – Scroll-Stopping Video Hooks' },
  'youtube-script': { slug: 'ai-youtube-script-writing', title: 'AI YouTube Script Writing – Complete Guide 2026' },
  'thumbnail-prompt': { slug: 'ai-thumbnail-prompts', title: 'AI Thumbnail Prompts – Design Click-Worthy Thumbnails' },
  'youtube-description': { slug: 'youtube-seo-descriptions', title: 'YouTube Description SEO – Rank Videos Higher' },
  'youtube-tags': { slug: 'youtube-tag-strategy', title: 'YouTube Tag Strategy – Long-Tail Keywords for Growth' },
  'youtube-seo': { slug: 'youtube-seo-optimization', title: 'Complete YouTube SEO Optimization Guide 2026' },
  'faceless-video': { slug: 'faceless-video-creation', title: 'Faceless Video Creation with AI – Build a Channel' },
  'viral-shorts': { slug: 'viral-shorts-strategy', title: 'Viral YouTube Shorts Strategy – Grow Fast in 2026' },
  'storytelling-script': { slug: 'storytelling-youtube-scripts', title: 'Storytelling YouTube Scripts – Engage Your Audience' },
  'community-post': { slug: 'youtube-community-engagement', title: 'YouTube Community Posts – Boost Engagement with AI' },
  'comment-reply': { slug: 'youtube-comment-management', title: 'YouTube Comment Management – AI Reply Generator' },
  'video-repurposer': { slug: 'video-content-repurposing', title: 'Video Content Repurposing – One Video, Many Platforms' }
};
