...
export const metadata = {
  ...
  openGraph: { title: 'Product Title Generator', description: 'Generate SEO-optimized product titles that rank higher in search results and drive more clicks and sales.' },
  twitter: { title: 'Product Title Generator', description: 'Generate SEO-optimized product titles that rank higher in search results and drive more clicks and sales.' }
};
