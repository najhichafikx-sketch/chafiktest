...
export const metadata = {
  ...
  openGraph: { title: 'AI Digital Product Creator', description: 'Create and optimize digital products with AI assistance. Generate product ideas, descriptions, and marketing copy.' },
  twitter: { title: 'AI Digital Product Creator', description: 'Create and optimize digital products with AI assistance. Generate product ideas, descriptions, and marketing copy.' }
};
