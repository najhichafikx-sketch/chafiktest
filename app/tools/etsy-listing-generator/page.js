...
export const metadata = {
  ...
  openGraph: { title: 'Etsy Listing Generator', description: 'Optimize your Etsy listings with SEO-friendly titles, tags, and descriptions that rank higher in Etsy search results.' },
  twitter: { title: 'Etsy Listing Generator', description: 'Optimize your Etsy listings with SEO-friendly titles, tags, and descriptions that rank higher in Etsy search results.' }
};
