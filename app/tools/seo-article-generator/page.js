...
export const metadata = {
  ...
  openGraph: { title: 'SEO Article Generator', description: 'Generate 100% original SEO articles, titles, keywords, and topic ideas optimized for Google rankings and AdSense approval.' },
  twitter: { title: 'SEO Article Generator', description: 'Generate 100% original SEO articles, titles, keywords, and topic ideas optimized for Google rankings and AdSense approval.' }
};
