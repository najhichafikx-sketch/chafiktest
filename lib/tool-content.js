...
export const TOOL_ARTICLES = {
  'seo-article': { slug: 'ai-seo-article-generator', title: 'How to Generate SEO Articles with AI – Complete Guide 2026', toolUrl: 'seo-article-generator' },
  'image-to-prompt': { slug: 'image-to-prompt-ai', title: 'Image to Prompt AI – How to Generate Perfect Prompts', toolUrl: 'image-to-prompt' },
  'video-to-prompt': { slug: 'video-to-prompt-ai', title: 'Video to Prompt AI Explained – Turn Videos Into Prompts', toolUrl: 'video-to-prompt' },
  'tiktok': { slug: 'tiktok-ai-tools', title: 'Best AI Tools for TikTok Content Creation in 2026', toolUrl: 'tiktok-tools' },
  'youtube': { slug: 'youtube-ai-suite', title: 'YouTube SEO with AI Suite – Rank Higher in 2026', toolUrl: 'youtube-suite' },
  'ai-humanizer': { slug: 'ai-humanizer-guide', title: 'AI Humanizer – Make AI Text Undetectable in 2026', toolUrl: 'ai-humanizer' },
  'ad-copy': { slug: 'ai-ad-copy-generator', title: 'How to Write Viral Ad Copy Using AI – Step by Step', toolUrl: 'ad-copy-generator' },
  'amazon-listing': { slug: 'amazon-ai-listing', title: 'Amazon Listing Optimization with AI – Boost Sales', toolUrl: 'amazon-listing-generator' },
  'product-description': { slug: 'ai-product-descriptions', title: 'AI Product Description Generator – Complete Guide', toolUrl: 'product-description-generator' },
  'etsy-listing': { slug: 'etsy-ai-listing', title: 'Etsy SEO with AI Listing Generator – Sell More', toolUrl: 'etsy-listing-generator' },
  'landing-page': { slug: 'ai-landing-page-generator', title: 'Landing Page Copy with AI – Conversion Focused', toolUrl: 'landing-page-generator' },
  'sales-copy': { slug: 'ai-sales-copy', title: 'AI Sales Copy That Converts – Proven Templates', toolUrl: 'sales-copy-generator' },
  'shopify-seo': { slug: 'shopify-ai-seo', title: 'Shopify SEO with AI Tools – Rank Your Store', toolUrl: 'shopify-seo-generator' },
  'product-title': { slug: 'ai-product-titles', title: 'AI Product Title Generator – Click Worthy Titles', toolUrl: 'product-title-generator' },
  'review-response': { slug: 'ai-review-responses', title: 'Automate Review Responses with AI – Save Time', toolUrl: 'review-response-generator' },
  'pricing': { slug: 'ai-pricing-optimization', title: 'AI Pricing Optimization Strategy – Maximize Profit', toolUrl: 'pricing-optimizer' },
  'product-idea': { slug: 'ai-product-ideas', title: 'Find Profitable Product Ideas with AI – 2026 Guide', toolUrl: 'product-idea-finder' },
  'product-image': { slug: 'ai-product-images', title: 'Enhance Product Images with AI – Ecommerce Guide', toolUrl: 'product-image-enhancer' },
  'digital-product': { slug: 'ai-digital-products', title: 'Create Digital Products with AI – Complete Guide', toolUrl: 'digital-product-creator' },
  'digital-name': { slug: 'ai-product-names', title: 'AI Digital Product Name Generator – Creative Names', toolUrl: 'digital-product-name-generator' },
  'email-writer': { slug: 'ai-email-marketing', title: 'AI Email Marketing Copy Guide – Higher Open Rates', toolUrl: 'digital-product-email-writer' },
  'dropshipping': { slug: 'ai-dropshipping-research', title: 'AI Dropshipping Product Research – Find Winners', toolUrl: 'dropshipping-research' },
  'prompt-article': { slug: 'ai-writing-prompts', title: 'Best AI Writing Prompts for Content Creation', toolUrl: 'prompt-article' },
  'prompt-viral': { slug: 'viral-content-prompts', title: 'Viral Content Prompts with AI – Go Viral on Social', toolUrl: 'prompt-viral' },
  'viral-ideas': { slug: 'youtube-viral-ideas', title: 'YouTube Viral Video Ideas – AI-Powered Content Strategy', toolUrl: 'viral-video-ideas' },
  'youtube-title': { slug: 'youtube-title-optimization', title: 'YouTube Title Optimization – Rank Higher with AI', toolUrl: 'youtube-title-generator' },
  'viral-hook': { slug: 'viral-hook-generation', title: 'Viral Hook Generator – Scroll-Stopping Video Hooks', toolUrl: 'viral-hook-generator' },
  'youtube-script': { slug: 'ai-youtube-script-writing', title: 'AI YouTube Script Writing – Complete Guide 2026', toolUrl: 'youtube-script-generator' },
  'thumbnail-prompt': { slug: 'ai-thumbnail-prompts', title: 'AI Thumbnail Prompts – Design Click-Worthy Thumbnails', toolUrl: 'thumbnail-prompt-generator' },
  'youtube-description': { slug: 'youtube-seo-descriptions', title: 'YouTube Description SEO – Rank Videos Higher', toolUrl: 'youtube-description-generator' },
  'youtube-tags': { slug: 'youtube-tag-strategy', title: 'YouTube Tag Strategy – Long-Tail Keywords for Growth', toolUrl: 'youtube-tags-generator' },
  'youtube-seo': { slug: 'youtube-seo-optimization', title: 'Complete YouTube SEO Optimization Guide 2026', toolUrl: 'youtube-seo-optimizer' },
  'faceless-video': { slug: 'faceless-video-creation', title: 'Faceless Video Creation with AI – Build a Channel', toolUrl: 'faceless-video-generator' },
  'viral-shorts': { slug: 'viral-shorts-strategy', title: 'Viral YouTube Shorts Strategy – Grow Fast in 2026', toolUrl: 'viral-shorts-generator' },
  'storytelling-script': { slug: 'storytelling-youtube-scripts', title: 'Storytelling YouTube Scripts – Engage Your Audience', toolUrl: 'storytelling-script-generator' },
  'community-post': { slug: 'youtube-community-engagement', title: 'YouTube Community Posts – Boost Engagement with AI', toolUrl: 'community-post-generator' },
  'comment-reply': { slug: 'youtube-comment-management', title: 'YouTube Comment Management – AI Reply Generator', toolUrl: 'comment-reply-generator' },
  'video-repurposer': { slug: 'video-content-repurposing', title: 'Video Content Repurposing – One Video, Many Platforms', toolUrl: 'video-content-repurposer' }
};
