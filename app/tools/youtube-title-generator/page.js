...
export const metadata = {
  ...
  openGraph: { title: 'YouTube Title Generator - AI SEO Video Titles', description: 'Generate SEO-optimized YouTube titles, clickable headlines, and Shorts titles that rank higher and get more views.' },
  twitter: { title: 'YouTube Title Generator - AI SEO Video Titles', description: 'Generate SEO-optimized YouTube titles, clickable headlines, and Shorts titles that rank higher and get more views.' }
};
