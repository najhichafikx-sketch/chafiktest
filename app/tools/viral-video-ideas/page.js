...
export const metadata = {
  ...
  openGraph: { title: 'Viral Video Idea Generator - AI YouTube Content Ideas', description: 'Generate viral YouTube video ideas with AI. Get trending content concepts, video angles, and audience-targeted ideas for your channel growth.' },
  twitter: { title: 'Viral Video Idea Generator - AI YouTube Content Ideas', description: 'Generate viral YouTube video ideas with AI. Get trending content concepts, video angles, and audience-targeted ideas for your channel growth.' }
};
