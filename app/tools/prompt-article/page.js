...
export const metadata = {
  ...
  openGraph: { title: 'AI Article Prompt Generator', description: 'Generate perfectly structured article prompts for AI writing tools. Get better output with optimized prompts.' },
  twitter: { title: 'AI Article Prompt Generator', description: 'Generate perfectly structured article prompts for AI writing tools. Get better output with optimized prompts.' }
};
