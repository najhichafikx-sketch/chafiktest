...
export const metadata = {
  ...
  openGraph: { title: 'Digital Product Email Writer', description: 'Write compelling email sequences for your digital products. Generate launch emails, follow-ups, and sales copy.' },
  twitter: { title: 'Digital Product Email Writer', description: 'Write compelling email sequences for your digital products. Generate launch emails, follow-ups, and sales copy.' }
};
