...
// Optimized 2026-06-13: relaxed thresholds for higher publish rate
// v3: max_tokens=16000 + softened gates for stable daily publishing
const MIN_WORD_COUNT = parseInt(process.env.MIN_WORD_COUNT) || 1200;
const MIN_SEO_SCORE = parseInt(process.env.MIN_SEO_SCORE) || 70;
const MIN_TRAFFIC_POTENTIAL = parseInt(process.env.MIN_TRAFFIC_POTENTIAL) || 40;
const MAX_AI_DETECTION = parseFloat(process.env.MAX_AI_DETECTION) || 0.8;
const MAX_KEYWORD_DENSITY = parseFloat(process.env.MAX_KEYWORD_DENSITY) || 0.04; // 4% (more lenient)
const MIN_FAQ_ANSWER_CHARS = parseInt(process.env.MIN_FAQ_ANSWER_CHARS) || 80;
