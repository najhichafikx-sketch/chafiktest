...
export const metadata = {
  ...
  openGraph: { title: 'AI Dropshipping Research Tool', description: 'Find profitable dropshipping products with AI-powered market research, trend analysis, and competition validation.' },
  twitter: { title: 'AI Dropshipping Research Tool', description: 'Find profitable dropshipping products with AI-powered market research, trend analysis, and competition validation.' }
};
