...
export const metadata = {
  ...
  openGraph: { title: 'Video Content Repurposer - AI Multi-Platform Content', description: 'Convert YouTube videos into blog articles, Twitter threads, Instagram posts, and LinkedIn content with AI.' },
  twitter: { title: 'Video Content Repurposer - AI Multi-Platform Content', description: 'Convert YouTube videos into blog articles, Twitter threads, Instagram posts, and LinkedIn content with AI.' }
};
