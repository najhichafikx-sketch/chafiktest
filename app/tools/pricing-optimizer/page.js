...
export const metadata = {
  ...
  openGraph: { title: 'AI Pricing Optimizer', description: 'Find the perfect price point for your products with AI-driven market analysis, competitor research, and customer insights.' },
  twitter: { title: 'AI Pricing Optimizer', description: 'Find the perfect price point for your products with AI-driven market analysis, competitor research, and customer insights.' }
};
