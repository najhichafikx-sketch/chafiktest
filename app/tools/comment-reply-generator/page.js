...
export const metadata = {
  ...
  openGraph: { title: 'Comment Reply Generator - AI YouTube Responses', description: 'Generate professional, engaging replies to YouTube comments. Build community with AI-powered responses.' },
  twitter: { title: 'Comment Reply Generator - AI YouTube Responses', description: 'Generate professional, engaging replies to YouTube comments. Build community with AI-powered responses.' }
};
