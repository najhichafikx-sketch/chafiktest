...
export const metadata = {
  ...
  openGraph: { title: 'YouTube Script Generator - AI Video Script Writer', description: 'Generate complete YouTube scripts for Shorts, long-form videos, and faceless channels. Includes intros, main content, and CTAs.' },
  twitter: { title: 'YouTube Script Generator - AI Video Script Writer', description: 'Generate complete YouTube scripts for Shorts, long-form videos, and faceless channels. Includes intros, main content, and CTAs.' }
};
