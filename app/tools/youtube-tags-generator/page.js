...
export const metadata = {
  ...
  openGraph: { title: 'YouTube Tags Generator - AI Video Tag Optimization', description: 'Generate relevant YouTube tags and long-tail keywords optimized for search discovery and video ranking.' },
  twitter: { title: 'YouTube Tags Generator - AI Video Tag Optimization', description: 'Generate relevant YouTube tags and long-tail keywords optimized for search discovery and video ranking.' }
};
